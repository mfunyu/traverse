...
function App() {
  ...
  const planData: Plan[] = [new Plan(now, null, [
    ...
    new Destination("Marceille, 80 rue de la république, 59100", [51.505, -0.09], null, now, 0, null),
    ...
    new Destination("Paris, 21 avenue des champs elysées, 75000", [48.85, 2.35], null, now, 2, "Say hi to the Eiffel Tower!"),
